...
export const
  ...
  autoRows = memoTheme((v, t) => css`grid-auto-rows: ${unit(v, get(t.grid, 'templateUnit', dT))};`),
  autoCols = memoTheme((v, t) => css`grid-auto-columns: ${unit(v, get(t.grid, 'templateUnit', dT))};`),
