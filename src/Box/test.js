...
import {renderFragment} from '../../test/test-utils'
...
test('<Box> -> ov', () => {
  ...
  expect(renderFragment(<Box ov='autoY hiddenX touch'/>)).toMatchSnapshot('autoY hiddenX touch')
  expect(renderFragment(<Box ov='autoY    hiddenX'/>)).toMatchSnapshot('autoY    hiddenX')
})
...
test('<Box> -> pos', () => {
  ...
  expect(() => renderFragment(<Box pos='throw'/>)).toThrowErrorMatchingSnapshot()
})
...
test('<Box> -> bw', () => {
  ...
  expect(() => renderFragment(<Box bw='p1'/>)).toThrowErrorMatchingSnapshot('throws direction')
  expect(() => renderFragment(<Box bw='t100'/>)).toThrowErrorMatchingSnapshot('throws scale direction')
  expect(() => renderFragment(<Box bw='100'/>)).toThrowErrorMatchingSnapshot('throws scale')
...
test('<Box> -> br', () => {
  ...
  expect(() => renderFragment(<Box br='p1'/>)).toThrowErrorMatchingSnapshot('throws direction')
  expect(() => renderFragment(<Box br='t100'/>)).toThrowErrorMatchingSnapshot('throws scale direction')
  expect(() => renderFragment(<Box br='100'/>)).toThrowErrorMatchingSnapshot('throws scale')
...
test('<Box> -> m', () => {
  ...
  expect(() => renderFragment(<Box m='p1'/>)).toThrowErrorMatchingSnapshot('throws direction')
  expect(() => renderFragment(<Box m='t100'/>)).toThrowErrorMatchingSnapshot('throws scale direction')
  expect(() => renderFragment(<Box m='100'/>)).toThrowErrorMatchingSnapshot('throws scale')
...
test('<Box> -> p', () => {
  ...
  expect(() => renderFragment(<Box p='p1'/>)).toThrowErrorMatchingSnapshot('throws direction')
  expect(() => renderFragment(<Box p='t100'/>)).toThrowErrorMatchingSnapshot('throws scale direction')
  expect(() => renderFragment(<Box p='100'/>)).toThrowErrorMatchingSnapshot('throws scale')
